...
def get_tokenization_args() -> Namespace:
    ...
    parser.add_argument("--multilingual", action="store_true",
                        help="Specify if the input data is multilingual. If it is multilingual, the input dataset is "
                             "expected to be given in `jsonlines` format. Otherwise, `sentence-per-line` format "
                             "is expected.")
...
def main() -> None:
    ...
    dataset_format = "json" if args["multilingual"] else "text"
